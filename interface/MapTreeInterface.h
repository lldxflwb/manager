...
public:
    ...
    virtual std::shared_ptr<std::vector<std::shared_ptr<PeopleInterface>>> get_peoples(PeopleRef people) = 0 ;
    virtual std::shared_ptr<std::vector<std::shared_ptr<PeopleInterface>>> get_order(int order = 0) = 0 ;
};
